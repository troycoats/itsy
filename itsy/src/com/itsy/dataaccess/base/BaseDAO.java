...
import com.itsy.exception.BlobNotFoundException;
import com.itsy.exception.RowLockedException;
...
// end rbs	
	 ...
	 * @throws Exception upon unexpected error.
	 * @see itsy.dataaccess.BaseDAO#getRSValueDateTime
	 */
	 ...
	 * @return date value contained by column indicated.
	 * @throws Exception upon unexpected error.
	 * @see itsy.dataaccess.BaseDAO#getRSValueDate
	 */
...
//				s = s.trim();
	...
	/**
	  ...
	  * @throws Exception upon unexpected error.
	  */
	public int getIdentityValueInt(String indexName, String tableName) throws Exception {
		try {
			return(getIdentityValueIntNoClose(indexName, tableName));
		} finally {
			close();
		}
	}
	...
	/**
	  ...
	  * @throws Exception upon unexpected error.
	  */
	public int getIdentityValueIntNoClose(String indexName, String tableName) throws Exception {
		int retVal = INVALID_ID_INT;
		try {
			setPStmt("SELECT " + indexName + " FROM " + tableName + " WHERE " + indexName + " = (SELECT MAX(" + indexName + ") FROM " + tableName + ");");
			executeQuery();

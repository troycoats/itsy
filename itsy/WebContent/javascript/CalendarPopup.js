...
function getCalendarStyles() {
	...
	result += "."+p+"cpYearNavigation,."+p+"cpMonthNavigation { background-color:#6BADF6; text-align:center; vertical-align:center; text-decoration:none; color:#333333; font-weight:bold; }\n";
	...
	result += "TD."+p+"cpCurrentDate { color:white; background-color: #6BADF6; }\n";

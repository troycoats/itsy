...
function CP_tmpReturnFunction(y, m, d) {
	...
	if (window.CP_targetInput.id == "hearingDate_0" || window.CP_targetInput.id == "hearing_1") {
		if (typeof afterDateSelected == 'function') {
			afterDateSelected();
		}
	}
}
...
function getCalendarStyles() {
	...
	result += "<STYLE>\n";
	result += "BODY { background-color:#F5F6F7; color:#333333; }\n";
	result += "."+p+"cpYearNavigation,."+p+"cpMonthNavigation { background-color:#1c87a3; text-align:center; vertical-align:center; text-decoration:none; color:#333333; font-weight:bold; }\n";
	result += "."+p+"cpDayColumnHeader, ."+p+"cpYearNavigation,."+p+"cpMonthNavigation,."+p+"cpCurrentMonthDate,."+p+"cpCurrentMonthDateDisabled,."+p+"cpOtherMonthDate,."+p+"cpOtherMonthDateDisabled,."+p+"cpCurrentDate,."+p+"cpCurrentDateDisabled,."+p+"cpTodayText,."+p+"cpTodayTextDisabled,."+p+"cpText { font-family: 'Segoe UI', Tahoma, Arial, Verdana, Sans-serif; font-size:11px; }\n";
	result += "TD."+p+"cpDayColumnHeader { text-align:right; border:solid thin #C0C0C0;border-width:0px 0px 1px 0px; }\n";
	result += "."+p+"cpCurrentMonthDate, ."+p+"cpOtherMonthDate, ."+p+"cpCurrentDate  { text-align:right; text-decoration:none; }\n";
	result += "."+p+"cpCurrentMonthDateDisabled, ."+p+"cpOtherMonthDateDisabled, ."+p+"cpCurrentDateDisabled { color:#D0D0D0; text-align:right; text-decoration:line-through; }\n";
	result += "."+p+"cpCurrentMonthDate, .cpCurrentDate { color:#000000; }\n";
	result += "."+p+"cpOtherMonthDate { color:#808080; }\n";
	result += "TD."+p+"cpCurrentDate { color:white; background-color: #1c87a3; }\n";
